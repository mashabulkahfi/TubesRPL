...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <!-- Brand -->
  <a class="navbar-brand" href="home.php">E-Toko</a>
  ...
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="home.php?category=Gadget">Gadget</a>
        <a class="dropdown-item" href="home.php?category=Fashion%20Pria">Fashion Pria</a>
        <a class="dropdown-item" href="home.php?category=Fashion%20Wanita">Fashion Wanita</a>
        <a class="dropdown-item" href="home.php?category=Fashion%20Anak">Fashion Anak</a>
        <a class="dropdown-item" href="home.php?category=Olahraga">Olahraga</a>
        <a class="dropdown-item" href="home.php?category=Rumah%20Tangga">Rumah Tangga</a>
      </div>
    </li>
  </ul>
    ...
    <div class="col-sm-12">
      <h3 style="text-align:center;">Katalog Barang E-Toko</h3><br />  
               <div class="container" style="width:700px;">  
                ...
                $query = "SELECT * FROM barang WHERE kategori LIKE '$category' ORDER BY id_barang ASC";  
